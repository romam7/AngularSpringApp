package com.roman.springboot.backend.apirest.controllers;
...
import com.roman.springboot.backend.apirest.models.services.IClienteService;
import com.roman.springboot.backend.apirest.models.services.IUploadFileService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> upload(@RequestParam("archivo") MultipartFile archivo, @RequestParam("id") Long id) {
		...
		if (!archivo.isEmpty()) {
			...
			response.put("mensaje", "Has subido correctamente la carga " + nombreArchivo);
